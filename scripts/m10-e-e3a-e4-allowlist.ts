...
export const M10_E_P1_P11_ALLOWLIST: readonly string[] = Object.freeze([
  ...
  // Corrective batch files - orchestration and tests
  'run-phase2.cmd',
  'run-phase2.sh',
  'tests/narrative-qa/m10-e-cache-instrumentation.test.ts',
  'tests/narrative-qa/m10-e-gate-reasons-parity.test.ts',
  'tests/narrative-qa/m10-e-reliability-cache-contract.test.ts',
  'tests/narrative-qa/m10-e-reliability-git-binding-proof.test.ts',
