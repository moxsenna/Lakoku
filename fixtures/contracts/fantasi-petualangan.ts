...
export const fantasiPetualanganContract = buildContractFixture({
  ...
  endingCandidates: [
    ...
    {
      key: 'silent-witness',
      name: 'Kesaksian Sunyi',
      kind: 'secret' as const,
      condition: 'Kirana menyembunyikan keberadaan Jantung Angin untuk melindungi kepulauan dari kekuasaan totaliter.',
      requiredClosure: ['Kirana menjadi penjaga rahasia.', 'Pulau-pulau selamat tanpa kompas.', 'Varun terus mencari tapi gagal.'],
      blockingConditions: [],
    },
  ],
  plotDebts: [
