...
export default function MulaiError({
  error,
  reset,
}: {
  ...
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-md flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="font-serif text-2xl font-medium tracking-tight text-foreground">
        Gagal Menyiapkan Cerita
      </h1>
      <p className="mt-2 text-sm text-muted-foreground">
        {isServerActionMismatch
          ? 'Versi aplikasi baru telah diperbarui. Memuat ulang rancangan ceritamu...'
          : 'Terjadi kendala saat menyusun premis atau bab cerita. Silakan coba lagi.'}
      </p>
      <div className="mt-6 flex w-full flex-col gap-3">
        ...
        >
          ...
          {isServerActionMismatch ? 'Muat Ulang' : 'Coba Lagi'}
        </Button>
        <Link href="/mulai" className={cn(buttonVariants({ variant: 'outline' }), 'w-full gap-2')}>
