#!/usr/bin/env node
/** Screenshot tablet rasio TEPAT 9:16 (syarat Play Console). */
import { chromium } from 'playwright'

const CHROME = 'C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe'
const BASE = 'http://localhost:3000'
const shots = [
  { name: 'tablet7-1-landing', url: '/', w: 1080, h: 1920 },
  { name: 'tablet7-2-login', url: '/auth/login', w: 1080, h: 1920 },
  { name: 'tablet10-1-landing', url: '/', w: 1440, h: 2560 },
  { name: 'tablet10-2-signup', url: '/auth/sign-up', w: 1440, h: 2560 },
]
