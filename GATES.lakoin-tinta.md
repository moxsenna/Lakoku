...
- [x] G12-M: Verifikasi RPC live (claim/dedupe/cap/tukar) di DB produksi saat deploy — Docker lokal tidak berjalan sehingga pgTAP/live tidak bisa dijalankan di mesin ini
