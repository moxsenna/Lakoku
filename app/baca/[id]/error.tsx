...
export default function BacaError({
  error,
  reset,
}: {
  ...
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-md flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="font-serif text-2xl font-medium tracking-tight text-foreground">
        Bab Belum Bisa Dibuka
      </h1>
      <p className="mt-2 text-sm text-muted-foreground">
        {isServerActionMismatch
          ? 'Versi aplikasi baru telah diperbarui. Memuat ulang bab...'
          : 'Terjadi kendala sementara saat memuat teks bab. Silakan coba lagi.'}
      </p>
