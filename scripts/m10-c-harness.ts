...
/**
 * Real commit this stage started from (branch HEAD at M10-C kickoff, recorded
 * in .superpowers/sdd/progress.md as "Base: 401f0f8"). Verifiable with
 * `git cat-file -t`. NOT the M10-A closure anchor. The manifest additionally
 * records the runtime `headSha` + `workingTreeDirty` so an uncommitted tree
 * can never masquerade as a clean provenance.
 */
export const C_BASELINE_SHA = '401f0f8716efe99b02e4179f1969d951dc92c74a'
