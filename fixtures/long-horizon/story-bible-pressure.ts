...
export function buildSyntheticStoryContract(): StoryContract {
  ...
  return {
    ...
    endingCandidates: [
      ...
      {
        key: 'ending_C',
        name: 'Penguasaan Sunyi',
        kind: 'secret' as const,
        condition: 'Arya menyamar menjadi pengikut Patih Brama untuk mengkhianati mereka dari dalam demi menghindari perang saudara.',
        requiredClosure: ['Patih Brama tewas di tangan sekutunya sendiri.', 'Rakyat tidak menyadari pahlawan sebenarnya.', 'Arya hidup sebagai pelayan raja baru.'],
        blockingConditions: [],
      },
    ],
