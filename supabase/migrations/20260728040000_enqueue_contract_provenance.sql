-- Enqueue contract provenance: snapshot story_contract_version at enqueue time.
--
-- enqueue_generation_job_v1 signature unchanged (4 params).
-- Body change: for personalized mode, read stories.story_contract_version
-- and store it in the new generation_jobs.story_contract_version column.
-- For standard mode, story_contract_version stays NULL.
